...
- `availableServicesForCountries` `(origins, countryCodes, restOfWorld)`: `[DeliveryAvailableService!]!` — The list of services offered for given destinations.
