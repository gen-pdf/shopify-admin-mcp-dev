/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1a0ff6b00d8633af8e4d5b326de65b72)
// Runtime types generated with workerd@1.20260317.1 2026-01-12 nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		GLOBAL_OUTBOUND: Service /* entrypoint GlobalOutbound from shopify-admin-mcp-staging */;
	}
	interface ProductionEnv {
		...
		SHOPIFY_ADMIN_API_VERSION: string;
		SHOPIFY_ADMIN_ACCESS_TOKEN: string;
		GLOBAL_OUTBOUND: Service /* entrypoint GlobalOutbound from shopify-admin-mcp */;
	}
	interface BeynarEnv {
		LOADER: WorkerLoader;
		ASSETS: Fetcher;
		...
		SHOPIFY_ADMIN_API_VERSION: string;
		SHOPIFY_ADMIN_ACCESS_TOKEN: string;
		GLOBAL_OUTBOUND: Service /* entrypoint GlobalOutbound from mcp-shopify-test */;
	}
	interface Env {
		LOADER: WorkerLoader;
		ASSETS: Fetcher;
		...
		SHOPIFY_ADMIN_API_VERSION: string;
		SHOPIFY_ADMIN_ACCESS_TOKEN: string;
		GLOBAL_OUTBOUND: Service /* entrypoint GlobalOutbound from shopify-admin-mcp-staging */ | Service /* entrypoint GlobalOutbound from shopify-admin-mcp */ | Service /* entrypoint GlobalOutbound from mcp-shopify-test */ | Service<typeof import("./src/index").GlobalOutbound>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHOPIFY_SHOP_DOMAIN" | "SHOPIFY_ADMIN_API_VERSION" | "SHOPIFY_ADMIN_ACCESS_TOKEN">> {}
}
