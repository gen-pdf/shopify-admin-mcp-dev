...
- `marketingChannel`: `MarketingChannel!` *(deprecated)* — The medium through which the marketing activity and event reached consumers. This is used for reporting aggregation.
...
- `statusBadgeType`: `MarketingActivityStatusBadgeType` *(deprecated)* — The severity of the marketing activity's status.
