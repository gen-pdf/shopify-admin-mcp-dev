# Object: `CheckoutBrandingBuyerJourney`
...
- `visibility`: `CheckoutBrandingVisibility` — An option to display or hide the breadcrumbs that represent the buyer's journey on 3-page checkout.

## Related Types

- [CheckoutBrandingVisibility](../../types/enums/CheckoutBrandingVisibility.md)
