...
```graphql
query UrlRedirectsCount($query: String, $savedSearchId: ID, $limit: Int) {
  urlRedirectsCount(query: $query, savedSearchId: $savedSearchId, limit: $limit) {
    count
  }
}
```
