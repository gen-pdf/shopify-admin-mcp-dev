...
- `description`: `String!` *(deprecated)* — The description of the application as defined by the Script.
...
- `title`: `String!` — The title of the application as defined by the Script.
