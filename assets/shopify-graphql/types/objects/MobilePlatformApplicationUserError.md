# Object: `MobilePlatformApplicationUserError`
...
- `code`: `MobilePlatformApplicationUserErrorCode` — The error code.
- `field`: `[String!]` — The path to the input field that caused the error.
- `message`: `String!` — The error message.

## Related Types

- [MobilePlatformApplicationUserErrorCode](../../types/enums/MobilePlatformApplicationUserErrorCode.md)
