...
- `adSpend`: `MoneyV2` — The total ad spend for the marketing content. Recurring weekly, monthly, or yearly spend needs to be divided into daily amounts.
...
- `sales`: `MoneyV2` — The amount of sales generated from the marketing content.
