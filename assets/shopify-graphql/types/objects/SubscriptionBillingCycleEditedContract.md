# Object: `SubscriptionBillingCycleEditedContract`

Represents a subscription contract with billing cycles.

**Implements:** `SubscriptionContractBase`
...
- `billingCycles` `(first, after, last, before, reverse, sortKey)`: `SubscriptionBillingCycleConnection!` — The billing cycles that the edited contract belongs to.
