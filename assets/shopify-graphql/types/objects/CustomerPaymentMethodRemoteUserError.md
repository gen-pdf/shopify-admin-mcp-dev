# Object: `CustomerPaymentMethodRemoteUserError`
...
- `code`: `CustomerPaymentMethodRemoteUserErrorCode` — The error code.
- `field`: `[String!]` — The path to the input field that caused the error.
- `message`: `String!` — The error message.

## Related Types

- [CustomerPaymentMethodRemoteUserErrorCode](../../types/enums/CustomerPaymentMethodRemoteUserErrorCode.md)
